...
describe("Homepage - filtering, sorting and search", () => {
    ...
    it("searches correctly", () => {
        ...
        cy.wait("@gqlGetMoviesQuery").then(({ request, response }) => {
            ...
            const initialMovies = (response?.body.data.movies ??
                []) as MoviePoster[];
    ...
    it("sorts correctly", () => {
        ...
        cy.get("#MOST_POPULAR").should("have.attr", "data-state", "checked");

        cy.get("#BEST_RATED").should("be.enabled").click();
        cy.get("#BEST_RATED").should("have.attr", "data-state", "checked");
        cy.get("#MOST_POPULAR").should("have.attr", "data-state", "unchecked");
        ...
        cy.get("#NEWEST_FIRST").should("have.attr", "data-state", "checked");
        cy.get("#BEST_RATED").should("have.attr", "data-state", "unchecked");
        ...
        cy.get("#MOST_POPULAR").should("have.attr", "data-state", "checked");
        cy.get("#NEWEST_FIRST").should("have.attr", "data-state", "unchecked");
        cy.get<MoviePoster[]>("@initialMovies").then((initialMovies) => {
            cy.checkMoviePosters(initialMovies);
        });
    });
    ...
    it("filters correctly", () => {
        ...
        cy.wait("@gqlGetMoviesQuery").then(({ request, response }) => {
            ...
            const filterMovies = (response?.body.data.movies ??
                []) as MoviePoster[];
    ...
    it("handles clear all correctly", () => {
        ...
        cy.wait("@gqlGetMoviesQuery").then(({ request, response }) => {
            ...
            const initialhMovies = (response?.body.data.movies ??
                []) as MoviePoster[];
    ...
    it("handles clear all with search correctly", () => {
        ...
        cy.wait("@gqlGetMoviesQuery").then(({ request, response }) => {
            ...
            const searchMovies = (response?.body.data.movies ??
                []) as MoviePoster[];
    ...
    it("handles loading more correctly", () => {
        ...
        cy.wait("@gqlGetMoviesQuery").then(({ request, response }) => {
            ...
            const responseMovies = (response?.body.data.movies ??
                []) as MoviePoster[];
